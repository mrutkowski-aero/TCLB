...
AddSetting(name="Velocity", default="1m/s", comment='Inlet or ustar or reference velocity', zonal=TRUE)
AddSetting(name="SpecificHeight", default="1m", comment='Roughness height', zonal=TRUE)
...
AddNodeType(name="WVelocityABL", group="BOUNDARY")
